      ...
      <div className="container">
        <Sec className="hero">
          <div className="contained">
            <h1>
              <strong className="str">JAMstack</strong>: 发音是 \’jam-stak’\{' '}
              <span>
                <br />
              </span>基于客户端 Js ，可复用 API 和预编译好的 Markup
              （标记语言）的摩登 web 开发架构。
            </h1>
          </div>
        </Sec>
        <Intro className="intro">
          <div className="contained">
            <div>
              这里我们说的 “技术栈” 不特指哪个操作系统， web
              服务器，后端语言，或者数据库。<br />
              <br />JAMstack 不是某些特定技术的组合. 它是一种新的开发网站和 App
              的方式，可以实现更高的运行速度和安全性，更低的扩展费用和更好的开发者体验。
            </div>
            <div className="faq">
              <h1>FAQ</h1>
              <Faq />
        ...
        <Breakdown id="what" className="breakdown">
          ...
          <div className="letter-definition">
            ...
            <p>
              所有请求/响应过程中的功能都用 JS
              开发，而且完全运行在浏览器中。可以用任意的 JS 框架，甚至纯 JS
              来写。
            </p>
          </div>
          <div className="letter-definition">
            ...
            <h1>APIs</h1>
            <p>
              所有服务器端功能都被抽象成了可复用的 API ，通过 JS 发 HTTP
              请求来调用。可以自建，也可以是第三方的 API 。
            </p>
          </div>
          <div className="letter-definition">
            ...
            <h1>Markup 标记语言</h1>
            <p>
              模板化的标记语言应该在部署前先编译。如果是内容型网站，一般用网站生成器来编译，如果是
              App ， 就用构建工具。<br />
              <br />
              <Link to="/Examples">例子？</Link>
            </p>
          </div>
        </Breakdown>
        <Jam_disqualifications className="jam-disqualifications">
          <h1>
            什么样的网站 <em>不属于</em> JAMstack ？
          </h1>
          <p>所有前后端紧密耦合的项目。包括：</p>
        ...
        <Why id="why" className="why">
          ...
          <div className="advantages-grid">
            <div className="advantage">
              <h4>高速</h4>
              <p>
                明明可以在部署前就编译成网页的内容，为何要让用户访问的时候才开始编译呢？说起打开速度，什么方式还能比部署到
                CDN 上的静态网页更快呢。
              </p>
            </div>
            <div className="advantage">
              ...
              <p>
                服务器端功能都抽出成了 API
                。我们自己的代码也没有什么可以被攻击的了，至于提供第三方 API
                的公司，一般也比较专注，所以也更专业。
              </p>
            </div>
            <div className="advantage">
